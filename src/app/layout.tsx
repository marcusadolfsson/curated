...
export const metadata: Metadata = {
  ...
  appleWebApp: {
    capable: true,
    title: "Curated",
    // Translucent: our own background runs under the status bar, so it is
    // whatever colour the page is - dark at night, light by day - instead
    // of a fixed light strip above a dark page.
